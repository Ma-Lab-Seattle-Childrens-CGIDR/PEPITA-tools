...
replacement_brfld = util.get_config("filename_replacement_brightfield_infection").split(
    replacement_delim
)
replacement_mask = util.get_config("filename_replacement_mask_infection").split(
    replacement_delim
)
replacement_subtr = util.get_config("filename_replacement_subtr_infection").split(
    replacement_delim
)
